...
def initConfig():
    ...
    setCell("sleepTime", 2)  # Задержка перед следующей проверкой на наличие новых сообщений. Просто не трогай...

    setCell("vk_AddFriends", False)  # Автоматически добавлять новых пользователей в друзья?
    setCell("vk_markAsReadEverything", True)  # Помечать прочитанными все сообщения?
    setCell("vk_login", "79052202853")  # Логин от аккаунта ВК
    setCell("vk_password", vk_pwd)  # Пароль от аккаунта ВК
